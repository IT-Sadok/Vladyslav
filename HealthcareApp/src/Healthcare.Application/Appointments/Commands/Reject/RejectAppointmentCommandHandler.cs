...
public class RejectAppointmentCommandHandler : IRequestHandler<RejectAppointmentCommand, Result<string>>
{
    ...
    public async Task<Result<string>> Handle(RejectAppointmentCommand request, CancellationToken cancellationToken)
    {
